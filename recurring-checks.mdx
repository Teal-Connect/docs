...
check can be applied on the user level or to the client level. If a user has recurring check configuration, it will always take precedence over the client level configuration.
