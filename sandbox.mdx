...
- Dayforce connections require setting `extra_login_params.company_name`.
...
## 6. Retrieve submitted Payroll information `/payroll/entries/connections`
...
## 7. Extract Payroll information from a payslip `/payroll/entries/payslips`
...
payroll provider login screen, where they can grant authorisation to share their data. Below is an example login page:
