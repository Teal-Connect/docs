...
Teal is a payroll API platform, streamlining the entire income verification process by connecting you to data sourced from payroll and HR systems or analysing income documents, all with the user authorisation at the core.
...
- **Production:** For real-world use. Base URL: `https://api.goteal.co`
- **Sandbox:** For testing with simulated data. Base URL: `https://api.sandbox.goteal.co`
...
1. Navigate to an endpoint definition. Example: [Create a user](/api-reference/users/create)
...
Import our API collection into Postman by pasting this URL into **Import** → **Link**:

```
https://docs.goteal.co/api-reference/openapi.yaml
```
