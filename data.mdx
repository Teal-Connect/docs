...
Response dates are always returned in UTC, representing the equivalent moment in time regardless of the original time zone. For example, 2PM in Berlin:
`2024-02-17T14:00:00+02:00` is returned as `2024-02-17T12:00:00Z`

When submitting dates to the API (such as in `POST /accounts`), you can include offsets, and these will be respected in all date calculations.
